...
<title>Gifty - Ticaret Admin Paneli</title>
    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li><a href="dashboard.html"> <i class="pe-7s-users"></i>
							<p>Kullanıcı İşlemleri</p>
					</a></li>
					<li><a href="user.html"> <i class="pe-7s-credit"></i>
							<p>Sipariş İşlemleri</p>
					</a></li>
					<li><a href="table.html"> <i class="pe-7s-shopbag"></i>
							<p>Ürün İşlemleri</p>
					</a></li>
					<li><a href="typography.html"> <i class="pe-7s-home"></i>
							<p>Gift-AnaSayfa</p>
					</a></li>
				</ul>
			</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href=""> Admin Hesap Ayarları </a></li>
